...
import com.soaic.libcommont.network.cookie.CookiesManager;
import com.soaic.libcommont.network.https.OkHttpSSLSocketFactory;
import com.soaic.libcommont.network.interceptor.HeaderInterceptor;
import com.soaic.libcommont.network.interceptor.HttpLoggingInterceptor;
import com.soaic.libcommont.network.listener.OnResultListener;
import com.soaic.libcommont.network.util.AppUtil;
