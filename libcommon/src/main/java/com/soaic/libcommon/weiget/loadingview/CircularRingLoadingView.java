...
public class CircularRingLoadingView extends BaseLoadingView {
    ...
    public CircularRingLoadingView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CircularRingLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
